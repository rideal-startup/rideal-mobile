...
class _LineDetailScreenState extends State<LineDetailScreen> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    setState(() {
      ...
      print("Amount of markers: " + this._markers.length.toString());
      _polylines.add(Polyline(
        ...
        visible: true,
        points: latlng,
        color: selected ? Colors.green : Colors.blueAccent,
        width: 5,
      ));
    });
  }
